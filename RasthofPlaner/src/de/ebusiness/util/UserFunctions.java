...
public class UserFunctions {
     ...
     * @param password
     * */
    public JSONObject registerUser(String anrede, String name, String vorname, String email, String telefonnummer, String password){
        // Building Parameters
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("tag", register_tag));
        params.add(new BasicNameValuePair("anrede", anrede));
